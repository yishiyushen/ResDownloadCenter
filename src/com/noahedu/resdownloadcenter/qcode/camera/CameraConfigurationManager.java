...
import com.noahedu.resdownloadcenter.qcode.PreferencesActivity;
import com.noahedu.resdownloadcenter.qcode.camera.metering.MeteringInterface;
...
final class CameraConfigurationManager {
  ...
  CameraConfigurationManager(Context context) {
	...
	void setCameraPreviewOrientation(int cameraId, Camera camera) {
	     ...
	     mRotation = result; //(360-result)%360; //info.orientation;
	 }
