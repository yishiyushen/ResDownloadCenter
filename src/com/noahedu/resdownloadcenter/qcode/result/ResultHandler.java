...
package com.noahedu.resdownloadcenter.qcode.result;
...
import com.noahedu.resdownloadcenter.qcode.Contents;
import com.noahedu.resdownloadcenter.qcode.LocaleManager;
...
public abstract class ResultHandler {
  ...
  final void launchIntent(Intent intent) {
    try {
      ...
      builder.setTitle(R.string.app_decode);
